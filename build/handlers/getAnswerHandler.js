...
exports.getAnswerHandler = void 0;
...
var getAnswerHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var messages, operationType, prompt, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('Inside get answer handler');
                messages = req.body.messages;
                operationType = req.body['operation-type'];
                console.log('Operation type: ' + operationType);
                prompt = (0, prompts_1.getPrompt)(operationType);
                console.log(prompt);
...
//# sourceMappingURL=getAnswerHandler.js.map